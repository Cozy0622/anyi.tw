...
const Home: React.FC = () => {
  ...
  return (
    <div className="flex-1 relative bg-[#0a0a0a]" ref={containerRef}>
      ...
      {/* 頁尾 */}
      <section id="partners" className="py-32 px-6 md:px-12 relative z-10 bg-[#121414] text-center">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          <h2 className="text-5xl md:text-[7rem] font-black mb-12 uppercase leading-none text-white tracking-tighter">Start <br /><span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-300 to-cyan-300">Future Care</span></h2>
          <div className="mt-20 w-full flex flex-col md:flex-row items-center gap-16 text-left">
            <div className="flex-1">
              <p className="text-emerald-400 mb-10 text-xs tracking-[0.4em] uppercase font-black">Connect With Us</p>
              <div className="flex gap-12 items-center">
                <a href="#" className="text-5xl text-white hover:text-emerald-400 transition-all"><iconify-icon icon="bi:instagram"></iconify-icon></a>
                <a href="#" className="text-5xl text-white hover:text-emerald-400 transition-all"><iconify-icon icon="bi:facebook"></iconify-icon></a>
                <a href="#" className="text-5xl text-white hover:text-emerald-400 transition-all"><iconify-icon icon="bi:line"></iconify-icon></a>
              </div>
            </div>
            <div className="flex-[1.2] w-full bg-white/5 p-10 rounded-[3rem] border border-white/10">
              <input type="email" placeholder="您的電子郵件 Email" className="w-full bg-white/5 border border-white/10 rounded-2xl px-8 py-5 mb-6 text-white focus:border-emerald-500 outline-none" />
              <textarea placeholder="留言諮詢..." rows={3} className="w-full bg-white/5 border border-white/10 rounded-2xl px-8 py-5 mb-6 text-white focus:border-emerald-500 outline-none" />
              <button className="w-full bg-emerald-500 py-5 rounded-2xl font-black text-black hover:bg-emerald-400 transition-all">送出留言</button>
            </div>
          </div>
          <footer className="mt-32 text-xs text-gray-600 uppercase tracking-widest">&copy; 2026 ANYI CARE. ALL RIGHTS RESERVED.</footer>
        </div>
      </section>
    </div>
  );
